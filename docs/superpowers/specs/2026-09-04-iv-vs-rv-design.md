...
| **R5** | [#29](https://github.com/lalitkarthik/delta-exchange-payoff/issues/29) | The screen: one chart, one slider, six checkboxes | `web/components/IvRvPanel.tsx` — the volatility section's second tab — and `IvRvChart.tsx` |
